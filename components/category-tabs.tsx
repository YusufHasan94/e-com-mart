            ...
            >
              {categories.map((category) => (
                <button
                  ...
                  className={`px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium transition-all duration-300 transform hover:scale-105 rounded-[4px] whitespace-nowrap shrink-0 ${activeCategory === category.slug
