...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Grand Theft Auto V is an action-adventure game set in the fictional state of San Andreas, based on Southern California.",
    platform: "Steam",
    variations: [
      { value: "Standard Edition", price: 14.99 },
      { value: "Premium Edition", price: 24.99 },
    ],
    vendors: [
      {
        id: 1,
    ...
    isTrending: true,
    customerReviews: [
      { user: "ActionGamer", rating: 4, comment: "Classic open world action!" },
      { user: "GTAFan", rating: 5, comment: "Best GTA game ever made." },
    ]
  },
  {
    ...
    description: "Adobe Photoshop CC 2024 is the world's most advanced image editing software with powerful AI-powered tools.",
    platform: "Adobe",
    variations: [
      { value: "Monthly Subscription", price: 119.99 },
      { value: "Annual Subscription", price: 1199.99 },
    ],
    vendors: [
      {
        id: 1,
    ...
    isTrending: false,
    customerReviews: [
      { user: "DesignerPro", rating: 5, comment: "Industry standard software!" },
      { user: "PhotoEditor", rating: 4, comment: "Amazing AI features." },
    ]
  },
  {
    id: "fifa-24",
    ...
    description: "FIFA 24 brings the beautiful game to life with enhanced gameplay, realistic graphics, and authentic football experience.",
    platform: "Steam",
    variations: [
      { value: "Standard Edition", price: 27.99 },
      { value: "Ultimate Edition", price: 49.99 },
    ],
    vendors: [
      {
        id: 1,
    ...
    isTrending: true,
    customerReviews: [
      { user: "FootballFan", rating: 4, comment: "Great football simulation!" },
      { user: "SportsGamer", rating: 4, comment: "Realistic gameplay." },
    ]
  },
  {
    id: "windows-11-pro",
    ...
    description: "Windows 11 Pro is the professional version of Microsoft's latest operating system with advanced security and productivity features.",
    platform: "Microsoft",
    variations: [
      { value: "Single License", price: 89.99 },
      { value: "Family License", price: 149.99 },
    ],
    vendors: [
      {
        id: 1,
    ...
    isTrending: false,
    customerReviews: [
      { user: "OfficeUser", rating: 4, comment: "Great productivity features!" },
      { user: "TechPro", rating: 5, comment: "Best Windows version yet." },
    ]
  }
]
